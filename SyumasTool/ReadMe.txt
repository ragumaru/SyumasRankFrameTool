...
＊＊＊＊＊現在開発中のためベータ版の提供となり、一部機能が実装されていません＊＊＊＊＊


■ファイル構成
+ _fonts フォルダ		あずきフォントが格納されています。
+ _image フォルダ		ランキング情報に使用するフレームが格納してあるフォルダです。
+ runtimes				画像を出力するライブラリ SkiaSharp が動作するのに必要なファイルです
- ～～～.dll			動作に必要なライブラリです。
...
　　・動画開始秒数、動画紹介秒数、動画ファイル名は現在は使用していません。空のままにしてください。
...
※あずきフォントが読み込めなくなったとして調査しようとしたが、HDDクラッシュでソースが消失しているため
...
　順位の位置、順位差の縁取り、長期作品の星マーク、動画タイトルが長い場合に横方向に縮めるなど前バージョンより改善
